<div class="border-end bg-white" id="sidebar-wrapper">
    <div class="sidebar-heading border-bottom bg-light" style="font-size: 1.2em;"><img src="www/img/logo.png" width="24" />&nbsp;&nbsp; Gabinete Digital</div>
    <div class="list-group list-group-flush">
        ...
        <a class="list-group-item list-group-item-action list-group-item-light px-4" href="?secao=proposicoes"><i class="bi bi-file-earmark-text"></i> Proposições do deputado</a>
        ...
        <a class="list-group-item list-group-item-action list-group-item-light px-4" href="?secao=oficios"><i class="bi bi-file-earmark-text"></i> Ofícios</a>
